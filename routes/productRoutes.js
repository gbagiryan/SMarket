...
router.post('/add_new_product', requireAuth, upload.array('productPictures'), validateAddProduct, isValidated, productController.product_post);
router.delete('/delete_product/:productId', requireAuth, productController.product_delete);
router.patch('/edit_product', requireAuth, upload.array('productPictures'), validateEditProduct, isValidated, productController.product_patch);
